...
public:
    ...
    CGSolverResult<result_T> solve_cg_method(int threads_num, bool mpi_machine_used,
        ...
        double total_time_all_retries = 0;
        double dot_product_elapsed_time_all_retries = 0;
        double spmv_elapsed_time_all_retries = 0;
        double axpby_elapsed_time_all_retries = 0;
        double dot_product_bandwidth_bytes_all_retries = 0;
        double spmv_bandwidth_bytes_all_retries = 0;
        double axpby_bandwidth_bytes_all_retries = 0;
        double cg_residual_all_retries = 0;
        long long iterations_all_retries = 0;
        ...
        for (int i = 0; i < max_retires; ++i) {
            ...
            axpby_elapsed_time_all_retries += axpby_elapsed_time;
            dot_product_bandwidth_bytes_all_retries += dot_product_bandwidth_bytes / dot_product_elapsed_time / 1048576;
            spmv_bandwidth_bytes_all_retries += spmv_bandwidth_bytes / spmv_elapsed_time / 1048576;
            axpby_bandwidth_bytes_all_retries += axpby_bandwidth_bytes / axpby_elapsed_time / 1048576;
            cg_residual_all_retries += ro_previous;
            iterations_all_retries += iteration;
        }
        result.dot_product_elapsed_time = dot_product_elapsed_time_all_retries / max_retires;
        result.spmv_elapsed_time = spmv_elapsed_time_all_retries / max_retires;
        result.axpby_elapsed_time = axpby_elapsed_time_all_retries / max_retires;
        result.dot_product_bandwidth = dot_product_bandwidth_bytes_all_retries / max_retires;
        result.spmv_bandwidth = spmv_bandwidth_bytes_all_retries / max_retires;
        result.axpby_bandwidth = axpby_bandwidth_bytes_all_retries / max_retires;
        result.iterations_taken = iterations_all_retries / max_retires;
        result.cg_residual = cg_residual_all_retries / max_retires;
        result.total_cg_time = total_time_all_retries / max_retires;
        return result;
    }
